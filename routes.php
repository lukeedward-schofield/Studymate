...
$router->patch("/tasks", "../Http/controller/main/tasks/patch.php")->only("auth");
...
$router->patch("/projects", "../Http/controller/main/projects/patch.php")->only("auth");
...
$router->patch("/reminders", "../Http/controller/main/reminders/patch.php")->only("auth");
